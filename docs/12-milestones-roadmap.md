...
**Local pipeline complete (steps 1–19).** Step 20 is a capped streamed scale-up from MSMARCO-XI train, not a 55.6 GB download. Deploy, videos, and `#RAGInGoa` posts remain user/submission work.
...
| 21 | Deploy live demo | User (needs a public host + secrets) |
